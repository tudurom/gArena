...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { content: @homework.content, lesson: @homework.lesson, student: @homework.student, time: @homework.time, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { content: @homework.content, lesson: @homework.lesson, student: @homework.student, time: @homework.time, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
